...
约翰逊词典最薄弱的地方子阿语语法，他觉得英语语法形态变化很少，所以不需要也不可能接受很多规则。最终，在1795年，林德利 默里（Lindly Murray）的《英语语法》出版了，并在下一世纪成为了权威著作。这些为语法努力的人，不是在“惯用法”的名义下进行，而是以逻辑和理性的名义进行，他们严斥双重比较（more better）禁止重复否定，试图分清除who、which、that的用法，对between和among进行区分，对强变化和不规则动词加以编排，对shall和will定下严密规则，对you was加以禁止
